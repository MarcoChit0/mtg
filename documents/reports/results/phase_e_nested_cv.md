...
- Friedman: statistic=132.1055, p=0.000000.
...
- Voting não é mais disparado automaticamente pela Fase E; no plano atualizado, ele deve virar etapa posterior à verificação dos modelos.
