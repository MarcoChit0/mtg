...
| `df_decision_tree` | 2.9333 |
| `df_logistic_regression` | 3.2667 |
| `df_linear_svc` | 4.9333 |
| `bc_random_forest` | 6.5333 |
| `bc_gradient_boosting` | 7.0667 |
| `bc_logistic_regression` | 7.4000 |
...
- `bc_decision_tree` vs `bc_gradient_boosting`: rank diff `4.6000`.
- `bc_decision_tree` vs `bc_random_forest`: rank diff `5.1333`.
- `bc_decision_tree` vs `df_decision_tree`: rank diff `8.7333`.
- `bc_decision_tree` vs `df_gradient_boosting`: rank diff `10.6000`.
- `bc_decision_tree` vs `df_linear_svc`: rank diff `6.7333`.
- `bc_decision_tree` vs `df_logistic_regression`: rank diff `8.4000`.
- `bc_decision_tree` vs `df_random_forest`: rank diff `8.8667`.
- `bc_gradient_boosting` vs `df_gradient_boosting`: rank diff `6.0000`.
- `bc_linear_svc` vs `df_decision_tree`: rank diff `6.4667`.
- `bc_linear_svc` vs `df_gradient_boosting`: rank diff `8.3333`.
- `bc_linear_svc` vs `df_linear_svc`: rank diff `4.4667`.
- `bc_linear_svc` vs `df_logistic_regression`: rank diff `6.1333`.
- `bc_linear_svc` vs `df_random_forest`: rank diff `6.6000`.
- `bc_logistic_regression` vs `df_decision_tree`: rank diff `4.4667`.
- `bc_logistic_regression` vs `df_gradient_boosting`: rank diff `6.3333`.
- `bc_logistic_regression` vs `df_random_forest`: rank diff `4.6000`.
- `bc_naive_bayes` vs `bc_random_forest`: rank diff `4.8000`.
- `bc_naive_bayes` vs `df_decision_tree`: rank diff `8.4000`.
- `bc_naive_bayes` vs `df_gradient_boosting`: rank diff `10.2667`.
- `bc_naive_bayes` vs `df_linear_svc`: rank diff `6.4000`.
- `bc_naive_bayes` vs `df_logistic_regression`: rank diff `8.0667`.
- `bc_naive_bayes` vs `df_random_forest`: rank diff `8.5333`.
- `bc_random_forest` vs `df_gradient_boosting`: rank diff `5.4667`.
- `df_decision_tree` vs `df_naive_bayes`: rank diff `6.6667`.
- `df_gradient_boosting` vs `df_naive_bayes`: rank diff `8.5333`.
...
>>>>>>> Stashed changes
=======
- `df_logistic_regression` vs `df_naive_bayes`: rank diff `6.3333`.
- `df_naive_bayes` vs `df_random_forest`: rank diff `6.8000`.
>>>>>>> Stashed changes
...
| `bc_gradient_boosting` | `bc_logistic_regression` | 44.0000 | 0.389404 |
