...
| `bc_linear_svc` | 6.9333 |
| `df_naive_bayes` | 8.0000 |
...
- `bc_linear_svc` vs `df_gradient_boosting`: rank diff `5.9333`.
- `bc_linear_svc` vs `df_logistic_regression`: rank diff `4.6000`.
- `bc_linear_svc` vs `df_random_forest`: rank diff `3.9333`.
...
- `df_gradient_boosting` vs `df_naive_bayes`: rank diff `7.0000`.
- `df_linear_svc` vs `df_naive_bayes`: rank diff `4.3333`.
- `df_logistic_regression` vs `df_naive_bayes`: rank diff `5.6667`.
- `df_naive_bayes` vs `df_random_forest`: rank diff `5.0000`.
...
| `bc_linear_svc` | `df_naive_bayes` | 0.0000 | 0.000061 |
