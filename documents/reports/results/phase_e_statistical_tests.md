...
- `bc_decision_tree` vs `bc_gradient_boosting`: rank diff `5.8000`.
- `bc_decision_tree` vs `bc_random_forest`: rank diff `4.6000`.
- `bc_decision_tree` vs `df_decision_tree`: rank diff `8.6667`.
- `bc_decision_tree` vs `df_gradient_boosting`: rank diff `10.6000`.
- `bc_decision_tree` vs `df_linear_svc`: rank diff `6.5333`.
- `bc_decision_tree` vs `df_logistic_regression`: rank diff `8.4000`.
- `bc_decision_tree` vs `df_random_forest`: rank diff `8.8667`.
- `bc_gradient_boosting` vs `bc_naive_bayes`: rank diff `5.4667`.
- `bc_gradient_boosting` vs `df_gradient_boosting`: rank diff `4.8000`.
- `bc_linear_svc` vs `df_decision_tree`: rank diff `6.4000`.
...
- `bc_logistic_regression` vs `df_decision_tree`: rank diff `4.8000`.
- `bc_logistic_regression` vs `df_gradient_boosting`: rank diff `6.7333`.
- `bc_logistic_regression` vs `df_logistic_regression`: rank diff `4.5333`.
- `bc_logistic_regression` vs `df_random_forest`: rank diff `5.0000`.
- `bc_naive_bayes` vs `df_decision_tree`: rank diff `8.3333`.
- `bc_naive_bayes` vs `df_gradient_boosting`: rank diff `10.2667`.
- `bc_naive_bayes` vs `df_linear_svc`: rank diff `6.2000`.
- `bc_naive_bayes` vs `df_logistic_regression`: rank diff `8.0667`.
- `bc_naive_bayes` vs `df_random_forest`: rank diff `8.5333`.
- `bc_random_forest` vs `df_gradient_boosting`: rank diff `6.0000`.
- `df_decision_tree` vs `df_naive_bayes`: rank diff `6.6000`.
- `df_gradient_boosting` vs `df_naive_bayes`: rank diff `8.5333`.
- `df_linear_svc` vs `df_naive_bayes`: rank diff `4.4667`.
