...
\begin{tikzpicture}
    ...
    \draw[->, ultra thick, color=solutionAction] (s0) -- (s2);
    \draw[->, thick] (s0) -- (s3) ;
    ...
    \draw[->, ultra thick, color=solutionAction] (s2) -- (s7) ;
    \draw[->, ultra thick, color=solutionAction] (s7) -- (s8) ;
    \draw[->, ultra thick, color=solutionAction] (s8.130) -- (s6) ;
    \draw[->, ultra thick, color=solutionAction] (s8.130)  to [bend left=25] (s2) ;
